...
class Bot:
    def __init__(self, token):
        ...
        @self.bot.on.chat_message(text=["-thk?изменения в расписании <param>", "-thk?замены <param>", "-thk?замены"])
        @self.bot.on.private_message(text=["изменения в расписании <param>", "замены <param>", "замены"])
        ...
        @self.bot.on.chat_message(text=["-thk?consutltations <teacher>", "-thk?консультации"])
        @self.bot.on.private_message(text=["консультации <teacher>", "консультации"])
